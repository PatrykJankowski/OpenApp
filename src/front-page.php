    ...
    <div class="container">
        <div class="row flex-reverse">
            <div class="col-md-6 center position-relative">
                ...
                <img src="/wp-content/themes/openapp/img/mockup1.webp" class="top-200" width="284" height="540" alt="Ekran telefonu">
            </div>
            <div class="col-md-6">
...
<section class="section section--pb-xxl">
    <div class="container">
        <div class="row">
            <div class="col-md-6 center position-relative">
                <img src="/wp-content/themes/openapp/img/mockup1.webp" width="284" height="540" alt="Rkean telefonu">
